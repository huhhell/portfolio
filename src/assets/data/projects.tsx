...
import {
    ...
    project03Images,
    project04Images,
    project05Images, project06Images, project07Images,
    ProjectImage
} from "./images.ts";
...
export const projects: Project[] = [
    ...
    {
        name: 'Portfolio',
        tech: [reactT, typeScript, reactRouter, styledComponents],
        descriptionShort: 'Личный сайт портфолио с описанием всех проектов',
        descriptionLong: 'Адаптивный сайт-портфолио. Спроектирован так, чтобы без труда управлять основной информацией на странице. Содержит блоки с контактами, технологиями, проектами, а так же страницу с детальным описанием проекта и с ссылками на него. Хорошо выглядит как на десктопных устройствах, так и на мобильных без потери функционала. ',
        img: project07Images,
        links: [{name: 'GitHub', link: 'https://github.com/huhhell/portfolioS', id: 0}, {name: 'Website', link: 'https://portfolio-s-liart.vercel.app/', id: 1}, {name: 'Notion', link: 'https://www.notion.so/credit-card-form-6e1325a527d14c0f94b0a96e700ad6a7?pvs=4', id: 3}, {name: 'Figma', link: 'https://www.figma.com/community/file/1181665852483619085/portfolio', id: 4}],
        category: 'Components',
        id: 6
    },
]
